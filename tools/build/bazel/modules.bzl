...
DRIVER_MAP = {
    ...
    "//drivers/openroadm:onos-drivers-openroadm-oar": [],
...
APP_MAP = {
    ...
    "//apps/openroadmprovider:onos-apps-openroadmprovider-oar": [],
    ...
    "//apps/opticalpathstore:onos-apps-opticalpathstore-oar": [],
    "//apps/opticalpathoptimizer:onos-apps-opticalpathoptimizer-oar": [],
...
MODELS_MAP = {
    ...
    "//models/openroadm2:onos-models-openroadm2-oar": [],
